...
export const en = {
  ...
  ai: {
    ...
    aiNotAvailable: 'AI service is not available',
    modelNotLoaded: 'AI model is not available. Please check your setup.',
    rateLimit: 'Too many requests. Please wait a moment before trying again.',
    aiThinking: 'AI is analyzing your answer...',
    lightweightModel: 'Using lightweight AI model for fast analysis',
    correct: 'Correct!',
    incorrect: 'Incorrect',
    greatJob: 'Great job! You got this question correct.',
    keepLearning: 'Keep learning! Review the explanation to understand better.',
