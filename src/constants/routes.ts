...
export const ROUTES = {
  ...
  blogPublic: (slug: string) => `/blog/${slug}`,
  ...
  quizzes: '/quizzes',
  contests: '/contests',
  mockTestMaker: '/mock-test-maker',
  questionPaperMaker: '/question-paper-maker',
  aiCourseMaker: '/ai-course-maker',
  quizGeneratorFromPdf: '/quiz-generator-from-pdf',
  toolsIndex: '/tools',
  ...
  student: {
    ...
    blog: (idOrSlug: string) => `/dashboard/student/blogs/${idOrSlug}`,
    ...
    contests: '/dashboard/student/contests',
    contestTake: (contestId: string) => `/dashboard/student/contests/${contestId}/take`,
    contestResult: (contestId: string) => `/dashboard/student/contests/${contestId}/result`,
  ...
  teacher: {
    ...
    contests: '/dashboard/teacher/contests',
    contestCreate: '/dashboard/teacher/contests/create',
    contestEdit: (id: string) => `/dashboard/teacher/contests/${id}/edit`,
    contestManage: (id: string) => `/dashboard/teacher/contests/${id}`,
