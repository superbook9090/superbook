        ...
        <div className="flex flex-wrap items-center gap-2 pt-2 md:pt-0">
          {enableCourses && (
            <Link
              ...
              className="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs sm:text-sm font-semibold antigravity-glass text-[var(--color-foreground)] border border-[var(--border)] hover:border-[var(--student-primary)]/50 hover:shadow-md transition-all duration-300"
            >
              <Search className="w-3.5 h-3.5 text-[var(--student-primary)]" />
          ...
          {enableQuizzes && (
            <Link
              ...
              className="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl text-xs sm:text-sm font-semibold antigravity-glass text-[var(--color-foreground)] border border-[var(--border)] hover:border-[var(--student-primary)]/50 hover:shadow-md transition-all duration-300"
            >
              <HelpCircle className="w-3.5 h-3.5 text-[var(--student-primary)]" />
          ...
          {enableCourses && enrolledCount > 0 && (
            <Link
              ...
              className="btn-premium inline-flex items-center gap-1.5 text-xs sm:text-sm !py-2 !px-3 hover:shadow-lg hover:scale-102 transition-all duration-300"
            >
