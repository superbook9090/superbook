    ...
    <PageWrapper>
      ...
      <div className="hero-banner flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 p-4 sm:p-6 md:p-8 rounded-3xl">
        <div className="space-y-1.5 max-w-xl">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold bg-[var(--error-light)] text-[var(--error)] border border-[var(--error)]/20 shadow-xs">
            ...
            <span>{t('admin.videoManagement')}</span>
          </div>
          <h1 className="heading-xl">{t('admin.videoManagement')}</h1>
      ...
      <FilterPanel>
        <DashboardListFilters
          ...
          searchPlaceholder={t('admin.searchVideos')}
        />
      </FilterPanel>
      ...
      {videos.length === 0 ? (
        <EmptyState
          title={t('admin.noVideosFound')}
          description={t('admin.noVideosDesc')}
          action={
