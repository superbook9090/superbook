...
export default function TeacherSidebar({ user }: { user: User | null }) {
  ...
  return (
    <div className="flex flex-col w-72 h-screen bg-gradient-to-b from-[var(--teacher-primary)] to-[var(--teacher-primary-dark)] relative overflow-hidden">
      {/* Decorative background elements */}
      <div className="absolute top-0 right-0 w-64 h-64 bg-white/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-48 h-48 bg-[var(--teacher-primary-light)]/10 rounded-full blur-3xl translate-y-1/2 -translate-x-1/2 pointer-events-none" />
        ...
        <nav className="mt-8 flex-1 px-4 space-y-1 min-h-0 overflow-y-auto">
          ...
          {isAdmin && (
            <div className="pt-4 mt-4 border-t border-white/10">
              <p className="px-4 text-xs font-semibold text-[var(--teacher-primary-light)]/70 uppercase tracking-wider mb-2">
      ...
      <div className="flex-shrink-0 p-4 relative z-10 bg-gradient-to-b from-transparent to-[var(--teacher-primary-dark)]/50">
        <div className="glass-dark rounded-2xl p-4">
          <div className="flex items-center">
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[var(--teacher-primary-light)] to-teal-400 flex items-center justify-center text-white font-semibold">
